...
const FIXED_MAIL = "aditya995407@gmail.com";
const FIXED_PHONE = "8587089954";

type MessageType = 'new' | 'ask' | 'thanks' | 'after' | 'closed';
...
export default function App() {
  ...
  // Simple URL shortening using TinyURL's public API
    ...
    <div className="min-h-screen bg-[#f5f5f5] text-[#1a1a1a] font-sans p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <header className="mb-12 text-center">
          ...
          <p className="text-muted-foreground text-gray-500">Create professional job referral messages in seconds.</p>
        </header>
